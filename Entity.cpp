...
//
//----------------------------------------
void Vehicle::setFileSufix(string s) {
  strcpy(mFileSufix, s.c_str());
};
...
void Vehicle::log(void){
    ...
    string fileName = "vehicle." +  string(mFileSufix) + "." + to_string(ID) + ".txt";
